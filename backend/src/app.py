...
async def run_thread():
    global time_keeper_thread
    if time_keeper_thread is None:
        time_keeper_thread = TimeKeeperThread()
        time_keeper_thread.start()
        print("started time keeper")


@app.get("/run/process")
async def run_process():
    global time_keeper_process
    if time_keeper_process is None:
        time_keeper_process = TimeKeeperProcess()
    time_keeper_process.start()
    print("started time keeper")
